...
\begin{equation}
g(x_t)=\frac{\tilde{r}}{p} \cdot x_t \cdot \left(1 - x_t^p\right)  	
\end{equation}
In this case, the maximum growth rate is $r = \tilde{r} / p$. To improve stability of the estimation, Fletcher [^4] reparameterised this model, writing it in the form:
\begin{equation}
